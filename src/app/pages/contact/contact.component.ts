      ...
      <div class="container">
        <div class="contact__header reveal" #reveal>
          ...
          <p class="section-subtitle">
            Estou sempre aberto a conexões. Fique à vontade para entrar em contato
            com perguntas, ideias ou oportunidades.
          </p>
        </div>
        ...
        <div class="contact__grid">
          ...
          <div class="contact__info reveal" #reveal>
            <div class="contact-item">
              ...
              <div>
                <p class="contact-item__label">Localização</p>
            ...
            <div class="contact-item">
              ...
              <div>
                <p class="contact-item__label">Telefone</p>
          ...
          <div class="contact__form-wrap reveal" #reveal>
            <form [formGroup]="form" (ngSubmit)="onSubmit()" class="contact-form" novalidate>
              <div class="form-field">
                ...
                <span class="form-error" *ngIf="f['name'].touched && f['name'].invalid">Nome é obrigatório.</span>
              </div>
              <div class="form-field">
                <label for="email">E-mail</label>
                <input id="email" type="email" formControlName="email" placeholder="seu@email.com" autocomplete="email">
                <span class="form-error" *ngIf="f['email'].touched && f['email'].errors?.['required']">E-mail é obrigatório.</span>
                <span class="form-error" *ngIf="f['email'].touched && f['email'].errors?.['email']">E-mail inválido.</span>
              </div>
              <div class="form-field">
                <label for="message">Mensagem</label>
                <textarea id="message" formControlName="message" rows="5" placeholder="Sua mensagem..."></textarea>
                <span class="form-error" *ngIf="f['message'].touched && f['message'].invalid">Mensagem é obrigatória (mín. 10 caracteres).</span>
              </div>
              ...
              <button type="submit" class="btn btn--primary" [disabled]="submitting">
                <span *ngIf="!submitting">Enviar Mensagem</span>
...
export class ContactComponent implements AfterViewInit {
    ...
    onSubmit(): void {
        ...
        this.contactService.send(this.form.value).subscribe({
            next: () => {
                this.successMsg = 'Mensagem enviada com sucesso! Responderei em breve.';
                this.form.reset();
                this.submitting = false;
            },
            error: () => {
                this.errorMsg = 'Erro ao enviar. Tente contato direto: ahsantos1301@gmail.com';
                this.submitting = false;
            }
        });
    }
