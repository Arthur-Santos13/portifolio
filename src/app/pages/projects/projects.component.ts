import { Component, OnInit, AfterViewInit, ViewChildren, QueryList, ElementRef, ChangeDetectorRef, inject } from '@angular/core';
    ...
    <section class="projects section-pad">
      <div class="container">
        <div class="projects__header reveal" #reveal>
          <p class="section-tag">{{ lang.t('projects.tag') }}</p>
          <h1 class="section-title">{{ lang.t('projects.title') }}</h1>
          <p class="section-subtitle">{{ lang.t('projects.subtitle') }}</p>
        </div>
...
export class ProjectsComponent implements OnInit, AfterViewInit {
  ...
  getFilters() {
    return this.filterKeys.map(f => ({
      value: f.value,
      label: this.lang.t(f.labelKey) !== f.labelKey ? this.lang.t(f.labelKey) : f.value
    }));
  }
